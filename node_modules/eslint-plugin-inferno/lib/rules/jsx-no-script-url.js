...
// https://github.com/facebook/inferno/blob/d0ebde77f6d1232cefc0da184d731943d78e86f2/packages/inferno-dom/src/shared/sanitizeURL.js#L30
    ...
    return {
      JSXAttribute(node) {
        ...
        if (shouldVerifyElement(parent, config) && shouldVerifyProp(node, config) && hasJavaScriptProtocol(node)) {
          context.report({
            node,
            message: 'A future version of Inferno will block javascript: URLs as a security precaution. '
