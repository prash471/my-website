...
module.exports = {
  ...
  create(context) {
    ...
    function isUsingInfernoChildren(node) {
      ...
      const isInfernoChildMethod = ['map', 'forEach'].indexOf(callee.property.name) > -1;
      if (!isInfernoChildMethod) {
        return null;
      }
    ...
    function getMapIndexParamName(node) {
      ...
      const callbackArg = isUsingInfernoChildren(node)
        ? node.arguments[1]
        : node.arguments[0];
